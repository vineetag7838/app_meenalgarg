		...
		stage('Kubernetes Deployment'){
			steps{
                ...
                script{
                    ...
                    step([$class: 'KubernetesEngineBuilder', projectId: 'sodium-burner-319611', clusterName: 'demo-cluster', location: 'us-central1', manifestPattern: deploymentFile, credentialsId: 'NAGP_jenkinsPipeline'])
                    try{
